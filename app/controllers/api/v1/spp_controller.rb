  ...
  module V1
    class SppController < ApiController
      ...
      def check_transaction
        order = Order.find_by_id(@data_respon_spp["id"].to_i)
      ...
      def noti_transaction_status
        ...
        if @data_respon_spp["amount"].to_i == order.grand_total.to_i*100 && order.save && @data_respon_spp["transaction_status"].to_i == 3
